...
type HomePageClientProps = StorefrontHomeData;
    ...
    <AppShell>
      <ScreenEnter>
        ...
        >
          ...
          >
            <motion.div className="relative z-[1] mx-auto flex max-w-[22rem] flex-col items-center">
              <motion.div className="relative flex w-full justify-center pb-1 pt-0.5">
                <span
            ...
            <motion.div className="relative z-[1] mt-3 grid grid-cols-2 gap-2">
